...
public class UserAuthActivity extends Activity implements LoaderManager.LoaderCallbacks<AccessToken>{
    ...
    private static class ObtainAccessTokenTask extends AsyncTaskLoader<AccessToken> {
        ...
        public AccessToken loadInBackground() {
            try {
                String formattedUrl = String.format(APIUrls.ACCESS_URL, mCode,
                        mClientMetadata.getClientID(),
                        mClientMetadata.getClientSecret());
    ...
    private class ProgressChromeClient extends WebChromeClient {
        ...
        private static final String PINCODE_PREFIX = "pincode=";
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            if (message.contains(PINCODE_PREFIX)) {
                mCode = message.substring(PINCODE_PREFIX.length());
    ...
    private class RedirectClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            String authScriptHackData = IOUtils.readRawResourceAsString(UserAuthActivity.this,
                    R.raw.autho_script);
            clientWebView.loadUrl("javascript:$('html').append('" + authScriptHackData + "')");
        }
    }
}
